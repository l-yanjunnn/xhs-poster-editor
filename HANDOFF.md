...
| 优先级 | 待办 | 一句话范围 |
|---|---|---|
| **P2·本地已完成待目检** | 结构化封面槽位与三套版式 | **v1.10.0 本地实现完成（2026-08-14，见 §0 当前迭代行），待用户目检+发布授权**；实施规格在 `docs/design/cover-slots-demo-2026-08-13/SPEC.md` |
